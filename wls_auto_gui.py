...
def main():
    ...
    if isAdmin():
        mess = tk.messagebox.showinfo(
            "ADMIN RIGHTS True YAY", "ALL Wright we can begin")
    else:
    ...
    b1 = tk.Button(canvas, fg="black", width=10,
                   text="RUN OP 1 ", command=say1)
    b1.place(x=20, y=50)
    ...
    b3 = tk.Button(canvas, fg="black", width=10,
                   text="ABOUT ME", command=About)
    b3.place(x=20, y=300)
